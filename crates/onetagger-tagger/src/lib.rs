...
impl Default for TaggerConfig {
    fn default() -> Self {
        Self {
            platforms: vec!["spotify".to_string()], 
            threads: 16, 
            strictness: 0.5, 
            path: None, 
            tags: vec![
                SupportedTag::Title, SupportedTag::Artist, SupportedTag::Album, SupportedTag::Key, SupportedTag::Genre, SupportedTag::Style, SupportedTag::ReleaseDate, SupportedTag::PublishDate, SupportedTag::AlbumArt, SupportedTag::OtherTags, SupportedTag::CatalogNumber, SupportedTag::TrackId, SupportedTag::ReleaseId, SupportedTag::Version, SupportedTag::Duration, SupportedTag::AlbumArtist, SupportedTag::Remixer, SupportedTag::TrackNumber, SupportedTag::TrackTotal, SupportedTag::DiscNumber, SupportedTag::Mood, SupportedTag::SyncedLyrics, SupportedTag::UnsyncedLyrics, SupportedTag::Label, SupportedTag::Explicit, SupportedTag::MetaTags, SupportedTag::BPM, SupportedTag::URL, SupportedTag::ISRC,
            ],
